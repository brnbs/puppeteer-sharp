...
{
    /// <summary>
    /// Represents a Playwright Firefox process and any associated temporary user data directory that have created
    ...
    public class FirefoxPlaywrightLauncher : LauncherBase
    {
        ...
        public FirefoxPlaywrightLauncher(string executable, LaunchOptions options)
